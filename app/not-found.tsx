  ...
  return (
    <section className="bg-[#1a2e44] text-white min-h-[70vh] flex items-center justify-center py-20 px-4">
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-[#3A6A96] font-semibold tracking-widest uppercase text-sm mb-4">404 — Page Not Found</p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/" className="inline-block bg-white text-[#1a2e44] hover:bg-[#3A6A96] hover:text-white font-semibold px-8 py-3 transition-colors">
            Back to Home
          </Link>
