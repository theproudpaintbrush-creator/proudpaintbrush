...
// Dark-background variant: charcoal elements recolored white, brand blue kept,
// so the logo reads on the navy footer without being flattened to a silhouette.
const LOGO_URL = "/images/logo-footer.png";
...
const socials = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/theproudpaintbrushllc",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/theproudpaintbrush",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/the-proud-paintbrush",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@theproudpaintbrush",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Professional residential and commercial painting serving Fort Bend
              County and West Houston since 2020.
            </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li>
                  <a
                    href="mailto:info@theproudpaintbrush.com"
                    className="hover:text-white transition-colors"
                  >
                    info@theproudpaintbrush.com
                  </a>
                </li>
                <li>Sugar Land, TX 77498</li>
              </ul>
            </div>
            <div>
