    ...
    <section className="bg-gray-50 py-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          <p className="text-sm font-semibold uppercase tracking-widest text-[#4B83B2] mb-2">How We Work</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {STEPS.map((s) => (
            <div key={s.n} className="bg-white border border-gray-200 p-6">
              <div className="w-9 h-9 bg-[#4B83B2] text-white rounded-full flex items-center justify-center font-bold mb-3">{s.n}</div>
